...
import './AnologClock.css';
import useEffectStories from '../../stories/UseEffect.stories';
...
export const AnalogClock = () => {
    ...
    return (
        ...
        <div className="clock">
            ...
            <div className="hand minute"style={{transform: `translate(-50%) rotate(${minutes/60*360}deg)`}}  ></div>
            <div className="hand second"style={{transform: `translate(-50%) rotate(${seconds/60*360}deg)`}}  ></div>
